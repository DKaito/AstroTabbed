...
public class MoonFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        timeMoonrise = getView().findViewById(R.id.timeMoonrise);
        timeMoonset = getView().findViewById(R.id.timeMoonset);
        newMoon = getView().findViewById(R.id.newMoon);
        fullMoon = getView().findViewById(R.id.fullMoon);
        moonDay = getView().findViewById(R.id.moonDay);
        moonPhase = getView().findViewById(R.id.moonPhase);
    }
